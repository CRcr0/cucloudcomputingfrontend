...
export default {
  ...
  data () {
    return {
      aList: [
      	//{'name':'Home Page','url':'/home','submenu':[]},
      	{'name':'User Management','url':'/home/user','submenu':[]},
      	{'name':'Product Management','url':'','submenu':[
         ...
         // {'name':'频道管理','url':'/home/channels'},
          //{'name':'Brand','url':'/home/brands'},
          {'name':'Picture Discription','url':'/home/pictures'},
      	]},
      	{'name':'Order Management','url':'/home/order','submenu':[]},
      	{'name':'System Management','url':'','submenu':[
          //{'name':'权限管理','url':'/home/author'},      		
      		//{'name':'User Management','url':'/home/group'},
          {'name':'Admin Management','url':'/home/admin'}      		
        ]},
      ],
