<template>
    ...
    <el-button type="primary" size="small" @click="pop_show = true" class="pull-right">Add Product Image</el-button>    
    <el-dialog title="Add Product Image" :visible.sync="pop_show" append-to-body>
        <el-form :model="PicturesForm" status-icon :rules="rulesBrandsForm" ref="BrandsForm" label-width="100px">
          ...
          <el-form-item label="Product Image" prop="logo">
            <el-upload 
            action=""
            :auto-upload="false">
          ...
          <el-form-item>
            ...
            <el-button @click="resetForm('ChannelsForm')">reset</el-button>
          </el-form-item>
        </el-form>
    </el-dialog>
	</div>  
